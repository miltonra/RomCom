...
.. py:method:: rc.data.designs.Measure.conjoinHeads(src: rc.base.definitions.PathLike, dst: rc.base.definitions.PathLike, headcount: int = 2) -> rc.base.definitions.Self
   :classmethod:
