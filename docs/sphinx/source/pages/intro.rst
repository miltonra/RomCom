...
----------------------
The ``rc`` package is organized in a modular hierarchy
...
The :ref:`rc.user` module comprises a gallery of archetypal user scripts to cannibalize.

User functionality is for the most part exposed in the penultimate module, :ref:`rc.run`. Any direct call to functionality outside ``rc.run``
